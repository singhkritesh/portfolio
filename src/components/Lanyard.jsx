...
// lanyard.png lives in public/ (not src/assets/) so Astro's image plugin
// doesn't touch it — the URL is a plain string at runtime.
...
export default function Lanyard({
  ...
  useEffect(() => {
    const handleScroll = () => {
      const next = window.scrollY > window.innerHeight ? 'never' : 'always';
